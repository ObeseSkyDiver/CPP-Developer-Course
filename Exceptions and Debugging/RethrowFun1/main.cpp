...
int main()
{
    ...
    try
    {
        ...
        doSomething(input);
        cout << "Yay! Main was able to process the num!" << endl;
...
void doSomething(int num)
{
    ...
    {
        processPositive(num);
        cout << "Yay! doSomething actually did something and processed that num!" << endl;
    }
    catch(const invalid_argument& e)
    {
    ...
    {
        cout << "doSomething says the number isn't within range!" << endl;
        throw; //rethrow
    }
